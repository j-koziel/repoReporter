...
var require_node_figlet = __commonJS((exports, module) => {
  var __dirname = "/home/jonathan/coding-stuff/repoReporter/node_modules/figlet/lib";
...
var require_command = __commonJS((exports) => {
  ...
  var childProcess = import.meta.require("node:child_process");
  var path = import.meta.require("node:path");
  var fs = import.meta.require("node:fs");
  var process2 = import.meta.require("node:process");
 ...
 - ${executableDirMessage}`;
    ...
    _chainOrCallSubCommandHook(promise, subCommand, event) {
      ...
      if (this._lifeCycleHooks[event] !== undefined) {
        this._lifeCycleHooks[event].forEach((hook4) => {
          result = this._chainOrCall(result, () => {
            return hook4(this, subCommand);
          });
        });
      }
      return result;
...
var package_default = {
  ...
  scripts: {
    ...
    "start:dev": "bun --watch ./src/app.ts",
    "start:prod": "bun run ./build/app.ts",
    lint: "eslint ."
  },
  devDependencies: {
...
program2.version(`${package_default.version}`).description("A CLI which will create Issues and Pulls reports from an organisations repositories").option("-i, --issues <value...>", "Create issues report for an organisation").option("-p, --pulls <value...>", "Create pulls report for an organisation").parse(process.argv);
var options = program2.opts();
if (!Object.keys(options).length) {
  console.log(import_figlet.default.textSync("Repo Reporter"));
  program2.outputHelp();
}
if (options.issues) {
